  ...
  return (
    <div className="w-full p-4 sm:p-6">
      ...
      <div className="mb-6">
        ...
        <p className="text-gray-500 mt-1">View customer feedback</p>
      </div>
          ...
          <tbody className="divide-y">
            {filteredFeedback.map((item) => (
              <tr key={item.feedback_id}>
                ...
                <td className="px-5 py-4">{item.service_name}</td>

               
               

                <td className="px-5 py-4 max-w-xs">{item.comment}</td>
              </tr>
            ))}
          </tbody>
        </table>
          ...
          >
            <div className="flex justify-between gap-3">
              <div>
                ...
                <p className="text-sm text-blue-600 mt-1">{item.feedback_id}</p>
              </div>
            ...
            <div className="mt-4 space-y-2 text-sm">
              <p>
                <strong>Customer ID:</strong> {item.customer_id}
              </p>
